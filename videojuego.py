...
ANCHO=640
ALTO=480
color_azul=(0,0,64) #color formatod rgb 
...
class Bolita(pygame.sprite.Sprite):
    def __init__(self):
        ...
        # Cargar imagen
        self.image = pygame.image.load('imagen/bolita.png')
...
class Paleta(pygame.sprite.Sprite):
    def __init__(self):
        pygame.sprite.Sprite.__init__(self)
        # Cargar imagen
        self.image = pygame.image.load('imagen/paleta.png')
        # Obtener rectángulo de la imagen
        self.rect = self.image.get_rect()
...
class Ladrillo(pygame.sprite.Sprite):
    def __init__(self, posicion):
        pygame.sprite.Sprite.__init__(self)
        # Cargar imagen
        self.image = pygame.image.load('imagen/ladrillo.png')
        # Obtener rectángulo de la imagen
        self.rect = self.image.get_rect()
